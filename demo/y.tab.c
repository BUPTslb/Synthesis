...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_include_preprocess = 10         /* include_preprocess  */
};
...
static const char *const yytname[] =
{
  ...
  "HEADERFILE", "'<'", "'>'", "'\"'", "$accept", "program",
  "include_preprocess", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* include_preprocess: INCLUDE '<' HEADERFILE '>'  */
#line 21 "frame.y"
        {
...
#line 1127 "y.tab.c"
  ...
  case 5: /* include_preprocess: INCLUDE '"' HEADERFILE '"'  */
#line 30 "frame.y"
        {
	g_Includes.push_back(Include());
        g_pInclude = &g_Includes.back();
